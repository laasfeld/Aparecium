...
set(inputTimeUnitText, 'String', 'Input time unit', 'Position',...
    [0.08181818181818182 0.7252012882447669 0.6545454545454545 0.05555555555555559],...
...
set(inputTimeUnitPopupmenu,...
    'Position', [0.08181818181818182 0.6363123993558779 0.8181818181818181 0.08148148148148154],...
...
set(MIDASTimeUnitText, 'String', 'MIDAS time unit', 'Position',...
    [0.08181818181818182 0.5425120772946861 0.7181818181818183 0.062962962962963],...
    'Background', [225/255 226/255 251/255],...
...
set(MIDASTimeUnitPopupmenu,...
    'Position', [0.08181818181818182 0.45732689210950095 0.8181818181818181 0.0851851851851852],...
...
set(timeShiftText, 'String', 'Time before measurement start', 'Position',...
    [0.045454545454545456 0.2753623188405797 0.8272727272727273 0.1594202898550725],...
    'Background', [225/255 226/255 251/255],...
...
set(timeShiftEdit, 'String', '0', 'Position',...
    [0.08181818181818182 0.17028985507246377 0.7545454545454546 0.07777777777777778],...
    'Background', [1 1 1],...
...
set(chooseFromStopwatchButton, 'String', '<html>Choose from<br>stopwatch', 'Position',...
    [0.09999999999999999 0.020724637681159424 0.7545454545454546 0.13768115942028986],...
