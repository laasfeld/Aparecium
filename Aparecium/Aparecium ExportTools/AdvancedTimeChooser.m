function varargout = AdvancedTimeChooser(varargin)
% ADVANCEDTIMECHOOSER MATLAB code for AdvancedTimeChooser.fig
%      ADVANCEDTIMECHOOSER, by itself, creates a new ADVANCEDTIMECHOOSER or raises the existing
%      singleton*.
%
%      H = ADVANCEDTIMECHOOSER returns the handle to a new ADVANCEDTIMECHOOSER or the handle to
%      the existing singleton*.
%
%      ADVANCEDTIMECHOOSER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ADVANCEDTIMECHOOSER.M with the given input arguments.
%
%      ADVANCEDTIMECHOOSER('Property','Value',...) creates a new ADVANCEDTIMECHOOSER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before AdvancedTimeChooser_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to AdvancedTimeChooser_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help AdvancedTimeChooser

% Last Modified by GUIDE v2.5 01-Jan-2010 15:09:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @AdvancedTimeChooser_OpeningFcn, ...
                   'gui_OutputFcn',  @AdvancedTimeChooser_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before AdvancedTimeChooser is made visible.
function AdvancedTimeChooser_OpeningFcn(hObject, eventdata, handles, exportTimeMomentController)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to AdvancedTimeChooser (see VARARGIN)

% Choose default command line output for AdvancedTimeChooser
...
% UIWAIT makes AdvancedTimeChooser wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function AdvancedTimeChooser_OutputFcn(hObject, eventdata, handles) 
