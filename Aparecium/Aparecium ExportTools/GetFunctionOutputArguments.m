...
%   Detailed explanation goes here
    ...
    elseif strcmp(inputFunctionAcronyme, 'Linear time model blank correction')
        channelNames = cell(1, 0);
        for channel = 1 : numel(inputChannelNames)
           channelNames{channel} = ['Linear time model blank corrected_', inputChannelNames{channel}]; 
        end
    else
