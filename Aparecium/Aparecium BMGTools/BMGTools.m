function varargout = BMGTools(varargin)
% BMGTOOLS M-file for BMGTools.fig
%      BMGTOOLS, by itself, creates a new BMGTOOLS or raises the existing
%      singleton*.
%
%      H = BMGTOOLS returns the handle to a new BMGTOOLS or the handle to
%      the existing singleton*.
%
%      BMGTOOLS('CALLBACK',hObject,eventData,handles,...) calls the
%      local
%      function named CALLBACK in BMGTOOLS.M with the given input
%      arguments.
%
%      BMGTOOLS('Property','Value',...) creates a new BMGTOOLS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before BMGTools_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to BMGTools_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @BMGTools_OpeningFcn, ...
                   'gui_OutputFcn',  @BMGTools_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before BMGTools is made visible.
function BMGTools_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to BMGTools (see VARARGIN)

% Choose default command line output for BMGTools
addApareciumToPath();
...
% UIWAIT makes BMGTools wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = BMGTools_OutputFcn(hObject, eventdata, handles) 
