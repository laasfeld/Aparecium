classdef Gen5Read < handle
    ...
    properties
        ...
        channels
        readName
        readNameWasAutogenerated = false % indicates if the read name was generated automatically (true) or was defined manually by the user (true). Useful for checking if
                                         % autogeneration was false of
                                         % unsuccessful
        wellID
        measurements
        ...
        mappingFinalized = false; % indicates if file line mapping has been completed for this read
    ...
    methods
        ...
        function setReadNameWasAutogenerated(this, readNameWasAutogenerated)
            this.readNameWasAutogenerated = readNameWasAutogenerated;
        end
        
        function readNameWasAutogenerated = getReadNameWasAutogenerated(this)
            readNameWasAutogenerated = this.readNameWasAutogenerated;
        end
        
        function finalizeMapping(this)
           this.mappingFinalized = true; 
        end
        
        function mappingFinalized = isMappingFinalized(this)
           mappingFinalized = this.mappingFinalized;
        end
